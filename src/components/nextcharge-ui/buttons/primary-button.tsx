...
export const PrimaryButton = (props: PrimaryButtonProps) => {
  ...
  return (
    <Button variant={variant}
            className="shadow group border-primary hover:bg-secondary h-fit cursor-pointer rounded-full border-1 px-0.5 py-0.5 focus-visible:border-inherit focus-visible:ring-0 [&_svg:not([class*='size-'])]:size-5.5">
      <span
