...
export const BlockContent = (props: HeroContentProps) => {
  ...
  return (
    <article
      className={cn(
        'mx-auto flex h-full w-full flex-col items-start gap-6 text-center md:text-left xl:gap-8',
        className
      )}
    >
      ...
      {description ? (
        <BodyText className="lg:w-11/12 xl:w-10/12">{description}</BodyText>
      ) : null}
      <div className="mx-auto mt-auto flex items-center gap-2.5 md:mx-0 md:mt-0">
        {buttons
